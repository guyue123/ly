...
//    private static final Logger LOG = Logger.getLogger(ScaleTool.class.getName());
    ...
    // 2017/07/26 轴不在物体中心时，缩放导致物体位置变化。物体的位置
    ...
    protected void onToolEvent(Event e) {
        ...
        modelCenter = ModelManager.getInstance().getTranslation(selectObj.getControlSpatial());
    ...
    public void update(float tpf) {
        ...
        controlObj.setLocalTranslation(getModelCenter());
        if (freeScale) {
    ...
    private Vector3f getModelCenter() {
    	if (modelCenter == null) {
    		return ModelManager.getInstance().getTranslation(selectObj.getControlSpatial());
    	}

 ...
 * @author huliqing
 */
public class SceneLightEntitiesConverter extends FieldConverter<JfxSceneEdit, EntityData> implements JfxSceneEditListener {
     ...
     * 光源：太阳光和灯光
     */
    private static List<String> entityTypes = new ArrayList<>(Arrays.asList(EntityConstants.ENTITY_DIRECTIONAL_LIGHT, EntityConstants.ENTITY_POINT_LIGHT));
    
    public SceneLightEntitiesConverter() {
        // 工具栏

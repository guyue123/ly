...
public abstract class AbstractEntity implements Entity {
    ...
    /** 实体空间原始副本，计算位置时使用 */
    /**中心位置*/
    protected Vector3f originSpatialCenter;
    /**缩放比*/
    protected Vector3f originSpatialScale;
    /**
     * 世界坐标
     */
    protected Vector3f originSpatialWorldTranslation;
    ...
    public final void initialize() {
        ...
        if (spatial != null && originSpatialCenter == null) {
        	this.setOriginInfo(spatial);
        }
     ...
     * @param OriginSpatial
     */
    private void setOriginInfo(Spatial OriginSpatial) {
    	if (OriginSpatial == null || ModelManager.getInstance().getModelCenter(OriginSpatial) == null) {
    		return;
    	}
